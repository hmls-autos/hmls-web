...
2. What should be scheduled soon
3. What can wait/be monitored
...
1. **Immediate**: Wheel bearing replacement (avoid highway driving)
2. **Within 1 month**: Front brake pad replacement
3. **Optional**: Consider replacing brake rotors with pads for best results
